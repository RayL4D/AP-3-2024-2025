 ...
 */
final class Version20241209140047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD le_user_id INT DEFAULT NULL, CHANGE statut statut VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP le_user_id, CHANGE statut statut VARCHAR(255) DEFAULT NULL');
    }
}
